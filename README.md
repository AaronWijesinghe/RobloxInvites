...
Joining other server members in a game (other person's username and display name have been redacted for privacy):<br>
...
You can generate playtime leaderboards (weekly/overall), game leaderboards, user profile cards, and live game/playtime leaderboards.
